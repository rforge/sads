...
bes.ln.octavtt <- octavpredt(x = en.bt, coef=c(-0.6610775, 1.3758715), sad="lnorm", trunc=0.05)
bes.gm.octavtt <- octavpredt(x = en.bt, coef=c(0.5675060, 0.6154372), sad="gamma", trunc=0.05)
bes.we.octavtt <- octavpredt(x = en.bt, coef=c(0.7947036, 0.8726019), sad="weibull", trunc=0.05)
plot(octav(en.bt))
points(bes.ln.octavtt)
